...
|--------|-------|----------|----------|
| 1 | [Python Basics](01-basics.md) | 1 hour | Variables, operators, string formatting for logging |
| 2 | [Lists and Indexing](02-lists.md) | 1 hour | Training data, batches, slicing |
| 3 | [Dictionaries](03-dictionaries.md) | 1 hour | Model configs, hyperparameters, metrics |
| 4 | [Loops and Iteration](04-loops.md) | 1.5 hours | Epoch loops, batch processing, early stopping |
| 5 | [NumPy Essentials](05-numpy.md) | 2 hours | Tensors, array operations, broadcasting |
| 6 | [Functions and Modules](06-functions.md) | 1.5 hours | Custom loss functions, importing PyTorch |
| 7 | [Mini-Project: MNIST](07-mini-project.md) | 2.5 hours | Complete ML pipeline end-to-end |
...
### 🤝 Community Support
Join our [GitHub Discussions](https://github.com/rajgupt/ai-for-builders/discussions) for help.
...
[**→ Start Lesson 1: Python Basics**](01-basics.md){ .md-button .md-button--primary }

## Additional Resources

- [Quizzes and Solutions](quizzes.md)
- [External Learning Resources](resources.md)
- [FAQ and Troubleshooting](resources.md#faq)

## Success Stories

After completing this course, you'll be ready to:

- Enroll in our [Introduction to ML](../../core/) course
...
**Questions?** Open an issue on [GitHub](https://github.com/rajgupt/ai-for-builders/issues) or join our [Discussions](https://github.com/rajgupt/ai-for-builders/discussions).

**License:** All content is MIT licensed. All code examples are free to use in your projects.

---

[← Back to Foundation Track](../index.md) | [Start Lesson 1 →](01-basics.md)
